      ...
      <footer style={footerStyles}>
        ...
        >
          <div style={{ marginBottom: "1rem" }}>
            ...
            <p class="text-left max-w-sm text-sm leading-tight">
              WanderMate is your trusted companion for discovering new places,
              exploring hidden gems, and making unforgettable memories. Whether
              you're planning your next adventure or just browsing for
              inspiration, we've got everything you need to make your travels
              extraordinary.
            </p>
          </div>
          <div
            style={{
              ...
              marginLeft: "-180px", // Increased value to move it left more
              marginTop: "20px",
            }}
          >
            <SiteLogo />
            <span
              style={{
                marginLeft: "0px", // You can also adjust this value if needed
                fontSize: "1.25rem",
                fontWeight: "bold",
              }}
            >
          ...
          <div>
            ...
            <br />
            <p>Contact Us At : wandermate4@outlook.com</p>
          </div>
        </div>
        <br />
        <div
          style={{
            ...
            left: "40%",
            transform: "translateX(5%)", // Centers it horizontally
            textAlign: "center",
          }}
        >
