...
const GuestNavigationMenuBar = ({ likedItemsCount = 0 }) => {
    ...
    <header className="w-full bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-2">
        <nav className="flex items-center justify-between">
          <Link to="/viewItineraries" className="flex items-center space-x-2">
            <SiteLogo />
          ...
          <div className="hidden md:flex space-x-6">
            <DropdownMenu open={openDropdown === "about"}>
              ...
              >
                <DropdownMenuItem>
                  <Link to="/aboutusguest" className="flex items-center">
                    <Info className="mr-2 h-4 w-4" />
                    <span>Our Story</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link to="/meetpageguest" className="flex items-center">
            ...
            <DropdownMenu open={openDropdown === "activities"}>
              ...
              >
                <DropdownMenuItem>
                  <Link to="/viewItinerariesGuest" className="flex items-center">
                    <MapPin className="mr-2 h-4 w-4" />
                    <span>Tours</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link to="/placesGuest" className="flex items-center">
                    <Ticket className="mr-2 h-4 w-4" />
                    <span>Attractions</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link to="/activitiesGuest" className="flex items-center">
                    <Ticket className="mr-2 h-4 w-4" />
                    <span>Events</span>
                  </Link>
                </DropdownMenuItem>
        ...
        <Button variant="outline" size="xs" style={{ left: "88%" }} onClick={() => navigate("/loginPage")}>
          Login
        </Button>
        <Button size="xs" style={{ left: "82.5%" }} onClick={() => navigate("/registerPage")}>
          Signup
        </Button>
</div>
...
export default GuestNavigationMenuBar;
