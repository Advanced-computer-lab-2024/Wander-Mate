    ...
    return (
      <>
        ...
        <div className="flex h-screen">
          ...
          <aside className="w-1/4 bg-gray-100 flex flex-col items-center py-6">
            <button className="bg-purple-600 text-white py-3 px-6 mb-4 rounded-lg shadow-lg hover:bg-purple-700 transition-all">
            <Link
            to="/viewItineraries"
            className="bg-purple-600 text-white py-3 px-6 mb-4 rounded-lg shadow-lg hover:bg-purple-700 transition-all"
          >
            View Itineraries
          </Link>
          ...
          <main className="flex-grow bg-white flex items-center justify-center">
            <h1 className="text-2xl font-semibold text-gray-800">Welcome to Our Tourist Portal</h1>
          </main>
        </div>
      </>
    );
