...
const MeetPageTG = () => {
  ...
  const users = [
    ...
    { id: 2, name: 'Youssef Khalil', email: 'youssef.khalil@student.guc.edu.eg', picture: pic2 },
    { id: 3, name: 'Andrew Wael', email: 'andrew.mikhael@student.guc.edu.eg', picture: pic3 },
    { id: 4, name: 'Mario Fady', email: 'mario.abdelmesseih@student.guc.edu.eg', picture: pic5 },
    { id: 5, name: 'Ramez Ehab', email: 'ramez.saleh@student.guc.edu.eg', picture: pic4 },
    { id: 6, name: 'John Nagi', email: 'john.alarja@student.guc.edu.eg', picture: pic6 },
    { id: 7, name: 'Peter Ragy', email: 'peter.saad@student.guc.edu.eg', picture: pic7 },
    { id: 8, name: 'Youssef Medhat', email: 'youssef.sedkey@student.guc.edu.eg', picture: pic8 },
    { id: 9, name: 'Nadeem Mohamed', email: 'nadeem.soliman@student.guc.edu.eg', picture: pic9 },
    { id: 10, name: 'Youssef Ashraf', email: 'youssef.abdelmalak@student.guc.edu.eg', picture: pic10 }
  ];
